...
class CartDrawerItems extends BaseCartItem {
  constructor() {
    ...
    this.cartContent = this.closest("[ui-drawer='content']");
    this.subTotal = this.cartContent.querySelector("[ui-cart-item='subtotal']");
  }
  ...
  getCartItemTemplate() {
    return this.cartContent.querySelector("template[ui-cart-drawer-item]");
  }
  ...
  getCartItemElements(cartItem) {
    const [image, title, price, deleteButton, quantity] =
      cartItem.querySelectorAll("[ui-cart-item]");
    return { image, title, price, quantity, deleteButton };
  }
...
class CartItems extends BaseCartItem {
  ...
  getCartItemElements(cartItem) {
    const [image, title, price, subtotal, deleteButton, quantity] =
      cartItem.querySelectorAll("[ui-cart-item]");
    return { image, title, price, quantity, subtotal, deleteButton };
  }
...
class CartSummary extends HTMLElement {
  ...
  updateCoupon(coupon, discountedPrice) {
    ...
    this.discount.querySelector("[data-value").textContent =
      this.getFormattedDiscountValue(coupon, discountedPrice);
    this.couponCode.querySelector("[data-value").textContent = coupon.code;
